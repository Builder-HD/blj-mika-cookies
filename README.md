        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 recipe-step">
                    ...
                    <img src="MixingButter.jpg" alt="Mixed Butter in a Plastic Bowl">
                </div>
                <div class="col-md-6 recipe-step">
                    <h5>Step 2</h5>
                    <p>Next add a grain of salt and 225 grams of sugar.</p>
                    <img src="AddSugar.jpg" alt="Step 2 Photo">
                </div>
                <div class="col-md-6 recipe-step">
                    <h5>Step 3</h5>
                ...
                <div class="col-md-6 recipe-step">
                    ...
                    <img src="PutThemOnAMetal.jpg" alt="Step 8 Photo">
                </div>
                <div class="col-md-6 recipe-step">
                    <h5>Step 13</h5>
                    <p>After that they are finished.</p>
                    <img src="FinishedCookies.jpg" alt="Step 8 Photo">
                </div>
            </div>
        </div>
    </section>
